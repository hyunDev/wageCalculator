...
export default function App() {
  ...
  }, [increment, pausedTime, startTime, wage]);
  ...
  const startPausedTime = useCallback(() => {
    const _pausedTime = pausedTime + 1;
    console.log('_pausedTime ::', _pausedTime);
    setPausedTime(_pausedTime);
  }, [pausedTime]);
