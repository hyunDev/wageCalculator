...
export default function TimerScreen({}) {
  ...
  useEffect(() => {
    ...
    console.log('startIncrementing :: ', startIncrementing);
    console.log('pickerChange ::', pickerChange);
    if (!pickerChange && startIncrementing) {
      /* if (intervalPauseId) {
        clearInterval(intervalPauseId);
      } */
      intervalStartId = setInterval(calculateWage, 1000);
      console.log('Start !!!');
      console.log('intervalStartId', intervalStartId);
    } else if (!pickerChange && !startIncrementing && startTime !== 0) {
      console.log('Clear !!');
      console.log('intervalStartId', intervalStartId);
      clearInterval(intervalStartId);
      // setPauseStartTime(getCurTime());
  ...
  return (
    <View style={[styles.container, {backgroundColor: '#333'}]}>
      ...
      <View style={styles.col}>
        ...
        <Text style={[styles.moneyText, {}]}>
          {startFormatTime}
          <Button title="Edit" onPress={() => setOpenStartTimePicker(true)} />
          <DatePicker
            modal
      ...
      <View style={styles.col}>
        ...
        <Text style={[styles.moneyText, {}]}>
          {endFormatTime}
          <Button title="Edit" onPress={() => setOpenEndTimePicker(true)} />
          <DatePicker
            modal
